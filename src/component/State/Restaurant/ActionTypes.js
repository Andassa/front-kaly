...
export const CREATE_RESTAURANTS_REQUEST = "GET_ALL_RESTAURANTs_REQUEST"; 
export const CREATE_RESTAURANTS_SUCCESS = "GET_ALL_RESTAURANTs_SUCCESS"; 
export const CREATE_RESTAURANTS_FAILURE = "GET_ALL_RESTAURANTs_FAILURE";
